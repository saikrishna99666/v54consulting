...
@section('title', 'Privacy Policy – ' . ($siteSettings->companyname ?? 'VISAWAY'))
                ...
                <div class="legal-content-card">
                    ...
                    <div class="legal-header-meta">
                        <span class="policy-badge">
                            <i class="fa-solid fa-lock"></i> Official Policy
                        </span>
                    ...
                    <div class="legal-body">
                        ...
                        @else
                            ...
                            <p>We are currently updating our Privacy Policy. Please check back soon or contact us directly using the details below for any questions regarding your privacy and data protection.</p>
                        @endif
                    </div>
                    ...
                    <div class="support-callout-box">
                        <div class="support-callout-content">
                            ...
                            <p>If you have any questions regarding our Privacy Policy or how your personal information is stored and processed, please reach out to our support helpline.</p>
                            <a href="{{ route('contact') }}" class="support-callout-btn">
                                Contact Legal Team <i class="fa-solid fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
