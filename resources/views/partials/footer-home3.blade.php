<style>
    ...
    .footer-section-3 {
        position: relative;
        background-color: #08182b; /* Premium deep navy */
        color: #cbd5e1;
    ...
    .top-list-custom a::after {
        ...
        bottom: 0;
        left: 0;
        background-color: #e21c25; /* Theme Red */
        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 mb-4">
                <div class="newsletter-card">
                    ...
                    <form id="subscribe-form" action="{{ route('subscribe') }}" method="POST" class="subscribe-form-custom">
                        @csrf
                ...
                <div class="footer-widget-custom">
                    ...
                    <ul class="service-list-custom">
                        @foreach($footerServices as $service)
                            <li>
                                <a href="{{ route('service.detail', $service->servicesUrl) }}">
        ...
        <div class="footer-bottom-custom">
            <div class="footer-bottom-wrapper-custom">
                <p class="copyright-text-custom">
                    Copyright &copy; {{ $siteSettings->copyrightyear ?? date('Y') }} <span>{{ $siteSettings->companyname ?? 'Visaway Immigration' }}</span>. All Rights Reserved.
                </p>
