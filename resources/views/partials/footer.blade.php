...
<footer class="footer-section-3 fix bg-cover"
    style="background-image: url({{ asset('assets/img/home-3/footer.jpg') }});">
    <div class="container">
                ...
                <div class="col-xl-6 col-md-6 col-lg-5">
                    <div class="single-footer-widget">
                        <div class="footer-content">
                            ...
                            <p>
                                Subscribe to receive the latest immigration news, visa tips, and expert updates straight
                                to your inbox.
                            </p>
                            ...
                            <h6>
                                Copyright© {{ $siteSettings->copyrightyear ?? date('Y') }} <span>{{ $siteSettings->companyname ?? 'VISAWAY' }}</span>
                                All Rights Reserved.
                            </h6>
                        </div>
                    </div>
